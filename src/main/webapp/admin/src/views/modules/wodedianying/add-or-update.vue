<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="电影编号" prop="dianyingbianhao">
          <el-input v-model="ruleForm.dianyingbianhao" 
              placeholder="电影编号" clearable  :readonly="ro.dianyingbianhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="电影编号" prop="dianyingbianhao">
              <el-input v-model="ruleForm.dianyingbianhao" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="电影链接" prop="dianyinglianjie">
          <el-input v-model="ruleForm.dianyinglianjie" 
              placeholder="电影链接" clearable  :readonly="ro.dianyinglianjie"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="电影链接" prop="dianyinglianjie">
              <el-input v-model="ruleForm.dianyinglianjie" 
                placeholder="电影链接" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shoujihao = true;
          ...
          if(o=='dianyinglianjie'){
            this.ruleForm.dianyinglianjie = obj[o];
	    this.ro.dianyinglianjie = true;
            continue;
          }
        }
      }
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `wodedianying/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.wodedianyingCrossAddOrUpdateFlag = false;
						 this.parent.search();
