<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="电影编号" prop="dianyingbianhao">
            <el-input v-model="ruleForm.dianyingbianhao" 
                placeholder="电影编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.dianyingbianhao" label="电影编号" prop="dianyingbianhao">
              <el-input v-model="ruleForm.dianyingbianhao" 
                placeholder="电影编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'&& !ro.yugaopian" label="预告片" prop="yugaopian">
          <file-upload
          tip="点击上传预告片"
          action="file/upload"
          :limit="1"
          :multiple="true"
          :fileUrls="ruleForm.yugaopian?ruleForm.yugaopian:''"
          @change="yugaopianUploadChange"
          ></file-upload>
        </el-form-item> 
        <div v-else>
          <el-form-item v-if="ruleForm.yugaopian" label="预告片" prop="yugaopian">
            <el-button type="text" size="small" @click="download($base.url+ruleForm.yugaopian)">预览</el-button>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.haibao" label="海报" prop="haibao">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.haibao.split(',')" :src="$base.url+item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="开映时间" prop="kaiyingshijian">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.kaiyingshijian" 
                type="date"
                :readonly="ro.kaiyingshijian"
                placeholder="开映时间">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.kaiyingshijian" label="开映时间" prop="kaiyingshijian">
              <el-input v-model="ruleForm.kaiyingshijian" 
                placeholder="开映时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="电影详情" prop="dianyingxiangqing">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.dianyingxiangqing" label="电影详情" prop="dianyingxiangqing">
                    <span v-html="ruleForm.dianyingxiangqing"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.dianyingfenlei = true;
          ...
          if(o=='yugaopian'){
            this.ruleForm.yugaopian = obj[o];
	    this.ro.yugaopian = true;
            continue;
          }
          if(o=='haibao'){
	    ...
	    this.ro.pingfen = true;
          ...
          if(o=='kaiyingshijian'){
            this.ruleForm.kaiyingshijian = obj[o];
	    this.ro.kaiyingshijian = true;
            continue;
          }
          if(o=='shizhang'){
	...
	this.ruleForm.dianyingxiangqing = this.ruleForm.dianyingxiangqing.replace(reg,'../../../ssmf7s0a/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
	...
	if(this.ruleForm.yugaopian!=null) {
		this.ruleForm.yugaopian = this.ruleForm.yugaopian.replace(new RegExp(this.$base.url,"g"),"");
	}
...
var objcross = this.$storage.getObj('crossObj');
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `fufeidianying/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.fufeidianyingCrossAddOrUpdateFlag = false;
						 this.parent.search();
    ...
    yugaopianUploadChange(fileUrls) {
	this.ruleForm.yugaopian = fileUrls;
	this.addEditUploadStyleChange()
    },
